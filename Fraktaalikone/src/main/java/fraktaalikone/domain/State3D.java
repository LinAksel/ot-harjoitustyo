...
public class State3D extends JPanel {
    ...
    public State3D(Color color, int chosen) {
        ...
        this.chosen = chosen;
        dots = 100000;
        points[0][0] = 100; points[0][1] = 100; points[0][2] = 100;
        points[1][0] = -100; points[1][1] = -100; points[1][2] = 100;
        points[2][0] = -100; points[2][1] = 100; points[2][2] = -100;
        points[3][0] = 100; points[3][1] = -100; points[3][2] = -100;
        builder();
        this.color = color;
    }
